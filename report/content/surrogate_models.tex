...
Trước khi đi vào nội dung của Chương 18 - Mô hình thay thế xác suất, ta cần biết mô hình thay thế (surrogate model) là gì. (\cite{algforopt_ch17})
...
\begin{itemize}
    ...
    \item Sử dụng hàm cơ sở: Các mô hình phổ biến thường là tổ hợp tuyến tính của các hàm cơ sở (basis functions) như đa thức (polynoverfittingomial), hình sin (sinusoidal) hoặc các hàm hướng tâm (radial basis functions - RBF).
